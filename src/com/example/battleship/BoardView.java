...
//    if( Game.gameGrid[1][1].has_ship )
//      canvas.drawLine( grid[1][1].x, grid[1][1].y, grid[2][2].x, grid[2][2].y,paint );
//
//    canvas.drawLine( grid[3][6].x, grid[3][6].y, grid[4][7].x, grid[4][7].y,paint );
